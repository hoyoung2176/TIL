...
// // exercise 1-2 아래 코드의 images 배열 안에 있는 정보(height, width) 를 곱해 넓이를 구하여 areas 배열에 저장하는 코드를 forEach 헬퍼를 이용하여 작성하자.
// const images = [
//     { height: 10, width:30},
//     { height: 20, width:90},
//     { height: 54, width:32},
...
// exercise 2-1 map 헬퍼를 사용해, images 배열 안의 Object 들만 저장되어 있는 heights 배열에 저장해보자.
const images = [
...
// exercise 2-3 다음 두 배열은 객체로 결합한 comics 배열을 만들어보자. (bands 요소가 key, movies 요소가 value)
// 힌트 : enumerate
const brands = ["Marvel", "DC"]
const movies = ["IronMan", "BatMan"]

// const comics = brands.map((x, i) => ({name:x, hero:movies[i]})) //()로 {}를 안묶으면 {}를 함수로 인식하기 때문에 오류가 발생할 수 있다.
const comics = {}
