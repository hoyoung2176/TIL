...
/*
    ...
    - 배열 검색 헬퍼들 : find, indexOf, lastIndexOf, some, every
*/
const USERS = [
    { name : 'Thor'},
    { name : 'Steve Rogers'},
...
console.log(ironMan)
// 5-1 PEOPLE 중에 admin 권한을 가진 요소를 찾아서 admin 에 저장하자.
const PEOPLE = [
    { id: 1, admin: false },
    { id: 2, admin: false },
    { id: 3, admin: true },
...
const account = ACCOUNTS.find(function (balance) {
...
// 6-2 USER 배열에서 모두가 hasSubmitted 인지 아닌지를 hasSubmitted 에 저장하라
const USER = [
...
const hasSubmitted = USER.every(function (user) {
